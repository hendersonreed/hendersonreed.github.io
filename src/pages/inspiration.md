...
I keep this running list of inspiring people and groups, so that I always can return here and find some useful threads to tug on.

- [Hundred Rabbits](https://100r.co/)
- [Brendan Bernhardt Gaffney](https://burn-heart.com/)
...
- [Zack Scholl](https://infinitedigits.co/)
